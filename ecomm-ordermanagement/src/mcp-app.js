...
app.post("/mcp", async (req, res) => {
  ...
  if (sessionIdHeader && sessions[sessionIdHeader]) {
    ...
    const {
      ...
      orderMcpRouter,
      orderItemMcpRouter,
      sys_orderPaymentMcpRouter,
      sys_paymentCustomerMcpRouter,
      sys_paymentMethodMcpRouter,
      getSessionRouter,
    } = require("mcpLayer")(initialHeaders);

    const sessionRouter = getSessionRouter(initialHeaders);

    orderMcpRouter.forEach((mcpTool) =>
      server.tool(
        mcpTool.name,
        mcpTool.description,
        mcpTool.parameters,
    ...
    orderItemMcpRouter.forEach((mcpTool) =>
      server.tool(
        mcpTool.name,
        mcpTool.description,
        mcpTool.parameters,
    ...
    sys_orderPaymentMcpRouter.forEach((mcpTool) =>
      server.tool(
        mcpTool.name,
        mcpTool.description,
        mcpTool.parameters,
    ...
    sys_paymentCustomerMcpRouter.forEach((mcpTool) =>
      server.tool(
        mcpTool.name,
        mcpTool.description,
        mcpTool.parameters,
    ...
    sys_paymentMethodMcpRouter.forEach((mcpTool) =>
      server.tool(
        mcpTool.name,
        mcpTool.description,
        mcpTool.parameters,
