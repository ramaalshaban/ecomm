...
class CheckoutRefreshOrderMcpController extends OrderManagementMcpController {
  constructor(params) {
    super("checkoutRefreshOrder", "checkoutrefreshorder", params);
    this.dataName = "order";
    this.crudType = "update";
  }

  createApiManager() {
    return new CheckoutRefreshOrderManager(this.request, "mcp");
  }
  ...
  static getInputScheme() {
    return {
      ...
      paymentUserParams: z
        ...
        .optional()
        .describe(
          "The user parameters that should be defined to refresh a stripe payment process",
        ),
    };
  }
}
...
module.exports = (headers) => {
  return {
    ...
    description: "Refresh checkout for order",
    parameters: CheckoutRefreshOrderMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CheckoutRefreshOrderMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CheckoutRefreshOrderMcpController.getOutputSchema().parse(result);
