...
class CheckoutCompleteOrderMcpController extends OrderManagementMcpController {
  constructor(params) {
    super("checkoutCompleteOrder", "checkoutcompleteorder", params);
    this.dataName = "order";
    this.crudType = "update";
  }

  createApiManager() {
    return new CheckoutCompleteOrderManager(this.request, "mcp");
  }
  ...
  static getInputScheme() {
    return {
      ...
      paymentUserParams: z
        ...
        .optional()
        .describe(
          "The user parameters that should be defined to complete a stripe payment process",
        ),
    };
  }
}
...
module.exports = (headers) => {
  return {
    ...
    description: "Complete checkout for order",
    parameters: CheckoutCompleteOrderMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CheckoutCompleteOrderMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CheckoutCompleteOrderMcpController.getOutputSchema().parse(result);
