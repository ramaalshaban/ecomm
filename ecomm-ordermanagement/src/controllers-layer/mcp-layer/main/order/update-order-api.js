...
class UpdateOrderMcpController extends OrderManagementMcpController {
  constructor(params) {
    super("updateOrder", "updateorder", params);
    this.dataName = "order";
    this.crudType = "update";
  }

  createApiManager() {
    return new UpdateOrderManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: UpdateOrderMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new UpdateOrderMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return UpdateOrderMcpController.getOutputSchema().parse(result);
