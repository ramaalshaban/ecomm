...
class CreateOrderPaymentMcpController extends OrderManagementMcpController {
  constructor(params) {
    super("createOrderPayment", "createorderpayment", params);
    this.dataName = "sys_orderPayment";
    this.crudType = "create";
  }

  createApiManager() {
    return new CreateOrderPaymentManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: CreateOrderPaymentMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new CreateOrderPaymentMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return CreateOrderPaymentMcpController.getOutputSchema().parse(result);
