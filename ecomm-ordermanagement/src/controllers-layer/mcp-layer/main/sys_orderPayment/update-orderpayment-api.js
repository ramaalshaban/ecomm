...
class UpdateOrderPaymentMcpController extends OrderManagementMcpController {
  constructor(params) {
    super("updateOrderPayment", "updateorderpayment", params);
    this.dataName = "sys_orderPayment";
    this.crudType = "update";
  }

  createApiManager() {
    return new UpdateOrderPaymentManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: UpdateOrderPaymentMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new UpdateOrderPaymentMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return UpdateOrderPaymentMcpController.getOutputSchema().parse(result);
