...
class GetOrderPaymentByOrderIdMcpController extends OrderManagementMcpController {
  constructor(params) {
    super("getOrderPaymentByOrderId", "getorderpaymentbyorderid", params);
    this.dataName = "sys_orderPayment";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetOrderPaymentByOrderIdManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetOrderPaymentByOrderIdMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetOrderPaymentByOrderIdMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetOrderPaymentByOrderIdMcpController.getOutputSchema().parse(result);
