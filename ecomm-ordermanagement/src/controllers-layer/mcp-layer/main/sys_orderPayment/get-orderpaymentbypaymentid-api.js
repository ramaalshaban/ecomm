...
class GetOrderPaymentByPaymentIdMcpController extends OrderManagementMcpController {
  constructor(params) {
    super("getOrderPaymentByPaymentId", "getorderpaymentbypaymentid", params);
    this.dataName = "sys_orderPayment";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetOrderPaymentByPaymentIdManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetOrderPaymentByPaymentIdMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetOrderPaymentByPaymentIdMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetOrderPaymentByPaymentIdMcpController.getOutputSchema().parse(result);
