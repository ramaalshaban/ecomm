...
class DeleteOrderPaymentMcpController extends OrderManagementMcpController {
  constructor(params) {
    super("deleteOrderPayment", "deleteorderpayment", params);
    this.dataName = "sys_orderPayment";
    this.crudType = "delete";
  }

  createApiManager() {
    return new DeleteOrderPaymentManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteOrderPaymentMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new DeleteOrderPaymentMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return DeleteOrderPaymentMcpController.getOutputSchema().parse(result);
