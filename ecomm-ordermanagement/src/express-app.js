...
const {
  ...
  orderRouter,
  orderItemRouter,
  sys_orderPaymentRouter,
  sys_paymentCustomerRouter,
  sys_paymentMethodRouter,
} = require("restLayer");

app.use("", orderRouter);
app.use("", orderItemRouter);
app.use("", sys_orderPaymentRouter);
app.use("", sys_paymentCustomerRouter);
app.use("", sys_paymentMethodRouter);
...
const { stripeDemoRouter } = require("restLayer");
const { paymentMethodsRouter } = require("restLayer");
app.use("/stripe-demo", stripeDemoRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "ecomm-orderManagement-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="ecomm-orderManagement-postman-collection.json"',
  );
