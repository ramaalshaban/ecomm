...
// This script is called from the GetOrderPaymentByPaymentIdManager
...
const dbScriptGetOrderpaymentbypaymentid = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Sys_orderPayment.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetOrderpaymentbypaymentid",
      {
...
module.exports = dbScriptGetOrderpaymentbypaymentid;
