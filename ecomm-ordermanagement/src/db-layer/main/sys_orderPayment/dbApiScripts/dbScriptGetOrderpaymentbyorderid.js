...
// This script is called from the GetOrderPaymentByOrderIdManager
...
const dbScriptGetOrderpaymentbyorderid = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetOrderpaymentbyorderid",
      {
...
module.exports = dbScriptGetOrderpaymentbyorderid;
