...
// This script is called from the GetOrderPayment2Manager
...
const dbScriptGetOrderpayment2 = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetOrderpayment2",
      {
...
module.exports = dbScriptGetOrderpayment2;
