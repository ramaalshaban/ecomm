...
// This script is called from the CheckoutStartOrderManager
...
const dbScriptCheckoutStartorder = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptCheckoutStartorder",
      {
...
module.exports = dbScriptCheckoutStartorder;
