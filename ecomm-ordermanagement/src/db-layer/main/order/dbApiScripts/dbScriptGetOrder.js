...
// This script is called from the GetOrderManager
...
const dbScriptGetOrder = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Order.findOne(options);
    ...
    console.log(err);
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenExecuting_dbScriptGetOrder", {
...
module.exports = dbScriptGetOrder;
