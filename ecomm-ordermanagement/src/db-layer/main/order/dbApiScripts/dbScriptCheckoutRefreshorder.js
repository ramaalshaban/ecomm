...
// This script is called from the CheckoutRefreshOrderManager
...
const dbScriptCheckoutRefreshorder = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptCheckoutRefreshorder",
      {
...
module.exports = dbScriptCheckoutRefreshorder;
