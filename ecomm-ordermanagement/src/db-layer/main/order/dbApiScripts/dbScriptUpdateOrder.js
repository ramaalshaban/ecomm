...
// This script is called from the UpdateOrderManager
...
const dbScriptUpdateOrder = async (apiManager) => {
  ...
  try {
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptUpdateOrder",
      {
...
module.exports = dbScriptUpdateOrder;
