...
describe("CreateOrderRestController", () => {
  let createOrder;
  ...
  beforeEach(() => {
    ...
    createOrder = proxyquire(
      "../../../src/controllers-layer/rest-layer/main/order/create-order-api.js",
      {
        serviceCommon: {
          HexaLogTypes: {},
        ...
        apiLayer: {
          CreateOrderManager: sinon.stub(),
        },
        "../../OrderManagementServiceRestController": class {
