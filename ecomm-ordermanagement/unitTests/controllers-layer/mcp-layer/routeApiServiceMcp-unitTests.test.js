...
describe("CreateOrderMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/order/create-order-api.js",
      {
        apiLayer: { CreateOrderManager: ManagerStub },
        "../../OrderManagementServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createOrder");
