...
import { useOrderManagementGetOrderPaymentByPaymentId } from "src/actions/orderManagement";

import { JsonResponse } from "../../../../components/json-response";
import { TableResponse } from "../../../../components/table-response";

export default function OrderManagementGetOrderPaymentByPaymentIdApiPage() {
  ...
  const { sys_orderPayment, sys_orderPaymentLoading, sys_orderPaymentError } =
    useOrderManagementGetOrderPaymentByPaymentId(submittedSys_orderPaymentId);

  const handleGetOrderpaymentbypaymentid = () => {
    ...
    <>
      <Box marginY="2rem">
        ...
        <Box component="div" gap="1rem" display="flex" key="0">
          ...
          <Button
            variant="outlined"
            onClick={handleGetOrderpaymentbypaymentid}
