...
import { useOrderManagementGetOrderPaymentByOrderId } from "src/actions/orderManagement";

import { JsonResponse } from "../../../../components/json-response";
import { TableResponse } from "../../../../components/table-response";

export default function OrderManagementGetOrderPaymentByOrderIdApiPage() {
  ...
  const { sys_orderPayment, sys_orderPaymentLoading, sys_orderPaymentError } =
    useOrderManagementGetOrderPaymentByOrderId(submittedSys_orderPaymentId);

  const handleGetOrderpaymentbyorderid = () => {
    ...
    <>
      <Box marginY="2rem">
        ...
        <Box component="div" gap="1rem" display="flex" key="0">
          ...
          <Button
            variant="outlined"
            onClick={handleGetOrderpaymentbyorderid}
