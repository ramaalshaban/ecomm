...
const metadata = { title: `CartItem data - Cart module - ${CONFIG.appName}` };

export default function CartCartItemAppPage() {
  const { setField, state } = useDataObjectContext();

  useEffect(() => {
    setField("name", "CartItem");
    setField("selectedApi", null);
    setField("defaultListRouteName", "listcartItems");
  ...
  const columns = [
    ...
    { field: "priceAtAdd", headerName: "priceAtAdd", flex: 1 },
