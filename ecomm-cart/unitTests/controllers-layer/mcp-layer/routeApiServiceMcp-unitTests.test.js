...
describe("CreateCartMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/cart/create-cart-api.js",
      {
        apiLayer: { CreateCartManager: ManagerStub },
        "../../CartServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createCart");
