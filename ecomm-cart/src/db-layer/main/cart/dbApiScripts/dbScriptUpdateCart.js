...
// This script is called from the UpdateCartManager
...
const dbScriptUpdateCart = async (apiManager) => {
  ...
  try {
    ...
    let rowsCount = null;
    let dbDoc = null;
    [rowsCount, [dbDoc]] = await Cart.update(dataClause, {
      where: whereClause,
      returning: true,
    });
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptUpdateCart",
      {
...
module.exports = dbScriptUpdateCart;
