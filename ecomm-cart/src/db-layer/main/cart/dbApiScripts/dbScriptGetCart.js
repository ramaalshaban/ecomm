...
// This script is called from the GetCartManager
...
const dbScriptGetCart = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Cart.findOne(options);
    ...
    console.log(err);
    //**errorLog
    throw new HttpServerError("errMsg_dbErrorWhenExecuting_dbScriptGetCart", {
...
module.exports = dbScriptGetCart;
