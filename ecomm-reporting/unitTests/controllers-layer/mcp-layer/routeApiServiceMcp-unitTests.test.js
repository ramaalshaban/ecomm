...
describe("CreateSalesReportMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/salesReport/create-salesreport-api.js",
      {
        apiLayer: { CreateSalesReportManager: ManagerStub },
        "../../ReportingServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createSalesReport");
