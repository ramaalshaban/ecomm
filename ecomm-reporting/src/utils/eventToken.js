...
const ProtectedObjectEvents = {
  salesReport: ["ecomm-reporting-service-salesreport-created"],
  exportJob: [
    "ecomm-reporting-service-exportjob-created",
    "ecomm-reporting-service-exportjob-retrived",
    "ecomm-reporting-service-exportjobs-listed",
  ],
  reportingJobAudit: [],
};
