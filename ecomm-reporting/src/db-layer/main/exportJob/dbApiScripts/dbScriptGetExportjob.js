...
// This script is called from the GetExportJobManager
...
const dbScriptGetExportjob = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await ExportJob.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetExportjob",
      {
...
module.exports = dbScriptGetExportjob;
