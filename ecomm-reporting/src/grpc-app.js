...
const reportingPackage = grpcObject.reporting;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is ecomm-reporting-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(reportingPackage.reportingService.service, {
  helloMessage,
  ...sessionRouter,
});
