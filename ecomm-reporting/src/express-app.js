...
const {
  ...
  salesReportRouter,
  exportJobRouter,
  reportingJobAuditRouter,
} = require("restLayer");

app.use("", salesReportRouter);
app.use("", exportJobRouter);
app.use("", reportingJobAuditRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "ecomm-reporting-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="ecomm-reporting-postman-collection.json"',
  );
