...
const ProtectedObjectEvents = {
  product: [
    "ecomm-productcatalog-service-product-created",
    "ecomm-productcatalog-service-product-updated",
    "ecomm-productcatalog-service-product-deleted",
    "ecomm-productcatalog-service-product-retrived",
    "ecomm-productcatalog-service-products-listed",
  ],
};
