...
const productCatalogPackage = grpcObject.productCatalog;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, { hello: "hello, this is ecomm-productcatalog-service" });
}

const {} = require("./controllers-layer/grpc-layer");

server.addService(productCatalogPackage.productCatalogService.service, {
  helloMessage,
  ...sessionRouter,
});
