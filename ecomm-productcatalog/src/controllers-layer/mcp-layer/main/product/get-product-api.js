...
class GetProductMcpController extends ProductCatalogMcpController {
  constructor(params) {
    super("getProduct", "getproduct", params);
    this.dataName = "product";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetProductManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetProductMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetProductMcpController(mcpParams);
      try {
        const result = await controller.processRequest();
        //return GetProductMcpController.getOutputSchema().parse(result);
