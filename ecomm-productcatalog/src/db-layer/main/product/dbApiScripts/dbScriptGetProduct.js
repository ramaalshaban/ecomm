...
// This script is called from the GetProductManager
...
const dbScriptGetProduct = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await Product.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetProduct",
      {
...
module.exports = dbScriptGetProduct;
