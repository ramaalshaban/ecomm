...
describe("CreateProductMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/product/create-product-api.js",
      {
        apiLayer: { CreateProductManager: ManagerStub },
        "../../ProductCatalogServiceMcpController": class {
