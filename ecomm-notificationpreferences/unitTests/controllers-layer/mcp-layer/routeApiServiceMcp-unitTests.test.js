...
describe("CreateUserNotificationPreferencesMcpController", () => {
  let factory;
  ...
  beforeEach(() => {
    ...
    factory = proxyquire(
      "../../../src/controllers-layer/mcp-layer/main/userNotificationPreferences/create-usernotificationpreferences-api.js",
      {
        apiLayer: { CreateUserNotificationPreferencesManager: ManagerStub },
        "../../NotificationPreferencesServiceMcpController": class {
  ...
  it("factory should return correct metadata", () => {
    ...
    expect(result.name).to.equal("createUserNotificationPreferences");
