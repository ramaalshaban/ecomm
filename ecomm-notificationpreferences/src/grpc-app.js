...
const notificationPreferencesPackage = grpcObject.notificationPreferences;

const server = new grpc.Server();

function helloMessage(call, callback) {
  callback(null, {
    hello: "hello, this is ecomm-notificationpreferences-service",
  });
}
...
server.addService(
  notificationPreferencesPackage.notificationPreferencesService.service,
  {
    helloMessage,
    ...sessionRouter,
  },
