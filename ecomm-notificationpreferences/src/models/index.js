...
const AdminNotificationConfig = require("./adminNotificationConfig");

UserNotificationPreferences.prototype.getData = function () {
...
AdminNotificationConfig.prototype.getData = function () {
  const data = this.dataValues;
  ...
  data._owner = data.adminId ?? undefined;
