...
const {
  ...
  userNotificationPreferencesRouter,
  adminNotificationConfigRouter,
} = require("restLayer");

app.use("", userNotificationPreferencesRouter);
app.use("", adminNotificationConfigRouter);
...
app.get("/getPostmanCollection", (req, res) => {
  const filePath = path.join(
    __dirname,
    "ecomm-notificationPreferences-postman-collection.json",
  );
  console.log("Downloading Postman Collection from:", filePath);
  res.setHeader("Content-Type", "application/json");
  res.setHeader(
    "Content-Disposition",
    'attachment; filename="ecomm-notificationPreferences-postman-collection.json"',
  );
