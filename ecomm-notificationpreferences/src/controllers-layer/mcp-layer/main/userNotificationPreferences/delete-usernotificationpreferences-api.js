...
class DeleteUserNotificationPreferencesMcpController extends NotificationPreferencesMcpController {
  constructor(params) {
    super(
  ...
  createApiManager() {
    return new DeleteUserNotificationPreferencesManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: DeleteUserNotificationPreferencesMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new DeleteUserNotificationPreferencesMcpController(
        mcpParams,
      );
      try {
        const result = await controller.processRequest();
        //return DeleteUserNotificationPreferencesMcpController.getOutputSchema().parse(result);
