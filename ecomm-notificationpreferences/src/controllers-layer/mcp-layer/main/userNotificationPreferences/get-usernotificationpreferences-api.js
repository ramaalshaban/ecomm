...
class GetUserNotificationPreferencesMcpController extends NotificationPreferencesMcpController {
  constructor(params) {
    super(
  ...
  createApiManager() {
    return new GetUserNotificationPreferencesManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: GetUserNotificationPreferencesMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      console.log("Mcp Request Received", mcpParams);
      mcpParams.headers = headers;
      const controller = new GetUserNotificationPreferencesMcpController(
        mcpParams,
      );
      try {
        const result = await controller.processRequest();
        //return GetUserNotificationPreferencesMcpController.getOutputSchema().parse(result);
