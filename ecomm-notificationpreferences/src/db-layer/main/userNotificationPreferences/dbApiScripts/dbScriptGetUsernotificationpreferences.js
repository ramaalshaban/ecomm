...
// This script is called from the GetUserNotificationPreferencesManager
...
const dbScriptGetUsernotificationpreferences = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await UserNotificationPreferences.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetUsernotificationpreferences",
      {
...
module.exports = dbScriptGetUsernotificationpreferences;
