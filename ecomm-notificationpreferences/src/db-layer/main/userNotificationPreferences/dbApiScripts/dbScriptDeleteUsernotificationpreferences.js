...
// This script is called from the DeleteUserNotificationPreferencesManager
...
const dbScriptDeleteUsernotificationpreferences = async (apiManager) => {
  ...
  try {
    ...
    apiManageruserNotificationPreferences = dbData;
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptDeleteUsernotificationpreferences",
      {
...
module.exports = dbScriptDeleteUsernotificationpreferences;
