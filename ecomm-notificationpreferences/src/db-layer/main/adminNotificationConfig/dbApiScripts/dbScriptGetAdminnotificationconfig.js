...
// This script is called from the GetAdminNotificationConfigManager
...
const dbScriptGetAdminnotificationconfig = async (apiManager) => {
  ...
  try {
    ...
    let rowData = await AdminNotificationConfig.findOne(options);
    ...
    throw new HttpServerError(
      "errMsg_dbErrorWhenExecuting_dbScriptGetAdminnotificationconfig",
      {
...
module.exports = dbScriptGetAdminnotificationconfig;
