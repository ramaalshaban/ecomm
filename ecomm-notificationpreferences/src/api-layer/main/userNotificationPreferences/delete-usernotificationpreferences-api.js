...
const { dbScriptDeleteUsernotificationpreferences } = require("dbLayer");

class DeleteUserNotificationPreferencesManager extends UserNotificationPreferencesManager {
  ...
  async doBusiness() {
    const usernotificationpreferences =
      await dbScriptDeleteUsernotificationpreferences(this);
  ...
  async raiseEvent() {
    UsernotificationpreferencesDeletedPublisher.Publish(
      this.output,
      this.session,
    ).catch((err) => {
...
module.exports = DeleteUserNotificationPreferencesManager;
