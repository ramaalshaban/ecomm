...
console.log("Starting ecomm-notificationpreferences-service service...");
...
const start = async () => {
  process.title = "node-ecomm-notificationpreferences-service";
  ...
  try {
    ...
    await setRedisData(
      "ecomm-notificationpreferences-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key ecomm-notificationpreferences-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "ecomm-notificationpreferences-service is listening HTTP/REST port " +
...
/* starting the server ecomm-notificationpreferences-service .... */
start();
