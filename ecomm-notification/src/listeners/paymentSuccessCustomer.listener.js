...
const consumer = kafka.consumer({
  groupId: `ecomm-notification-service-paymentSuccessCustomer-group`,
});

const paymentSuccessCustomerListener = async () => {
    ...
    eachMessage: async ({ topic, partition, message }) => {
      try {
        ...
        const mappedData = {
          types: ["email"],
          isStored: false,
          template: "paymentSuccessCustomerTemplate",
          metadata: {
            ...notice,
            actionDeepLink: "",
            actionText: "",
...
module.exports = paymentSuccessCustomerListener;
