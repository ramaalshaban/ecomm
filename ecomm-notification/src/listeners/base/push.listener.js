...
const consumer = kafka.consumer({
  groupId: `ecomm-notification-service-push-consumer`,
});
...
const runPushSenderListener = async () => {
  ...
  await consumer.subscribe({
    topic: `ecomm-notification-service-notification-push`,
    fromBeginning: true,
  });
  ...
  await consumer.run({
    eachMessage: async ({ topic, partition, message }) => {
      try {
        ...
        //**errorLog
        console.error(`ecomm-notification-service-notification-push: `, error);
      }
    },
  });
};
