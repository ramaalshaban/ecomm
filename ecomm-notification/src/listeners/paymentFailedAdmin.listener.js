...
const consumer = kafka.consumer({
  groupId: `ecomm-notification-service-paymentFailedAdmin-group`,
});

const paymentFailedAdminListener = async () => {
    ...
    eachMessage: async ({ topic, partition, message }) => {
      try {
        ...
        const mappedData = {
          types: ["email"],
          isStored: false,
          template: "paymentFailedAdminTemplate",
          metadata: {
            ...notice,
            actionDeepLink: "",
            actionText: "",
...
module.exports = paymentFailedAdminListener;
