...
const consumer = kafka.consumer({
  groupId: `ecomm-notification-service-orderPlacedCustomer-group`,
});

const orderPlacedCustomerListener = async () => {
    ...
    eachMessage: async ({ topic, partition, message }) => {
      try {
        ...
        const mappedData = {
          types: ["email"],
          isStored: false,
          template: "orderPlacedCustomerTemplate",
          metadata: {
            ...notice,
            actionDeepLink: "",
            actionText: "",
...
module.exports = orderPlacedCustomerListener;
