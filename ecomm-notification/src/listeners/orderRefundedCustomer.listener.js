...
const consumer = kafka.consumer({
  groupId: `ecomm-notification-service-orderRefundedCustomer-group`,
});

const orderRefundedCustomerListener = async () => {
    ...
    eachMessage: async ({ topic, partition, message }) => {
      try {
        ...
        const mappedData = {
          types: ["email"],
          isStored: false,
          template: "orderRefundedCustomerTemplate",
          metadata: {
            ...notice,
            actionDeepLink: "",
            actionText: "",
...
module.exports = orderRefundedCustomerListener;
